...
SH = 511
BASEY = SH * 0.8
FPS = 32  # Used for start screen only
...
def game_start(generation, x, y):
    ...
    while True:
        ...
        # Speed limit removed for faster training
        # FPSCLOCK.tick(FPS)
